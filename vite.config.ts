...
import { defineConfig, type LibraryOptions, type LibraryFormats, type Plugin } from 'vite';
...
export default entryConfig(path.resolve(__dirname, 'src/index.ts'), 'jsdomExtended');
